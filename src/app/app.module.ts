...
@NgModule({
  declarations: [Test, PageNotFound, AppComponent, Home, ClientDetails, TokenDisplay, Main, Auth, UserProfile, ScopeDisplay, ClientsDisplay, KeysPipe, ValuesPipe, QuantityParsePipe, ClientParsePipe, SearchFilterPipe],
