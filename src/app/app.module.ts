...
@NgModule({
  declarations: [AppComponent, Home, ClientDetails, Main, Auth, UserProfile, ScopeDisplay, ClientsDisplay, KeysPipe, ValuesPipe, QuantityParsePipe, ClientParsePipe, SearchFilterPipe],
