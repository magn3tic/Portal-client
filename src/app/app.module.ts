...
import {Test, PageNotFound, Home, ClientDetails} from './ui';
...
@NgModule({
  declarations: [Test, PageNotFound, AppComponent, Home, ClientDetails, Main, Auth, UserProfile, ScopeDisplay, ClientsDisplay, KeysPipe, ValuesPipe, QuantityParsePipe, ClientParsePipe, SearchFilterPipe],
